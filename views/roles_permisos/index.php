...
<div class="row justify-content-md-center mt-1">
    <div class="col-12">
        <h4 class="text-center" style="font-weight: bold;">Gestión de Permisos para el Rol</h4>
        <h3 class="text-center pb-3" style="color: #0d3b66; font-weight: bold; border-bottom: 1px solid #ccc;"><?= $rol_descripcion ?></h3>
    </div>
</div>
<form id="formPermisos">
            ...
            <ul class="list-group">
                <?php foreach ($modulos as $m): ?>
                    <li class="list-group-item list-group-item-action"
                        onclick="showSubmodules('mod<?= $m['id'] ?>')">
                    ...
                    <ul class="list-group">
                        <?php if (!empty($subPorModulo[$m['id']])): ?>
                            <?php foreach ($subPorModulo[$m['id']] as $s): ?>
                                <li class="list-group-item list-group-item-action"
                                    onclick="showPermissions('subm<?= $s['id'] ?>-md<?= $m['id'] ?>')">
    ...
    <div class="row mt-3">
        <div class="col-4">
            <a href="web.php?controller=rol&action=index" class="btn btn-danger">Cancelar</a>
...
<script src="src/js/Actions/rolPermisos.js"></script>
